...
<h3>新增广告位</h3>
	...
	<div id="right">
	<FORM METHOD=POST ACTION="admin/ad_loca_add.do">
	  <table border="1">
	  <tr>
	  	<td>位置名称</td>
	  	<td><INPUT TYPE="text" NAME="locationName" value=""></td>
	  </tr>
	   <tr>
	  	<td>位置描述</td>
	  	<td><INPUT TYPE="text" NAME="locationDescriptions" value=""></td>
	  </tr>
	  <tr>
	  	<td>宽度</td>
	  	<td><INPUT TYPE="text" NAME="locationWidth" value="1"></td>
	  </tr>
	  <tr>
	  	<td>高度</td>
	  	<td><INPUT TYPE="text" NAME="locationHigh" value="1"></td>
	  </tr>
	  <tr>
	  	<td>广告源码</td>
	  	<td><INPUT TYPE="text" NAME="locationCode" value="1"></td>
	  </tr>
	  </table>
